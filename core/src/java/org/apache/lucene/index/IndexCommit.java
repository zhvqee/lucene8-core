...
/**
 *
 *  IndexCommit 代表了Segement 段文件的提交，内容的可见性。
 *
 *  IndexCommit 代表一次commit,
 *   为了让索引的修改数据能被检索， 必须通过一个新的段以提交一个commit，
 *   在某个时间点，新的段文件被写入完成后，一个index commit
 *   每个段文件都有唯一的一个index commit 与之关联，
