...
public abstract class MultiLevelSkipListReader implements Closeable {
    ...
    public int skipTo(int target) throws IOException {
        ...
        //skipDoc 每一层的最开始的文档ID
        //跳表是按文档ID 从小到大排序的，
        int level = 0;
        //找到某一层，该层的docId>= target 的文档，即该文档docId 之后的文档ID都大于target
        ...
        while (level >= 0) {
            ...
            } else { //这里发现target 已经小于等于某一层的docId,
